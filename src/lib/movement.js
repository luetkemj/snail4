...
export const attack = (entity, targetId) => {
  ...
  if (targetEntity.components.health.current <= 0) {
    ...
    if (targetEntity.components.description) {
      targetEntity.components.description.text = `You see a crumpled ${targetEntity.components.labels.name} on the floor. You see a crumpled ${targetEntity.components.labels.name} on the floor. You see a crumpled ${targetEntity.components.labels.name} on the floor. You see a crumpled ${targetEntity.components.labels.name} on the floor. You see a crumpled ${targetEntity.components.labels.name} on the floor. You see a crumpled ${targetEntity.components.labels.name} on the floor. You see a crumpled ${targetEntity.components.labels.name} on the floor. You see a crumpled ${targetEntity.components.labels.name} on the floor. You see a crumpled ${targetEntity.components.labels.name} on the floor. You see a crumpled ${targetEntity.components.labels.name} on the floor. You see a crumpled ${targetEntity.components.labels.name} on the floor. You see a crumpled ${targetEntity.components.labels.name} on the floor. You see a crumpled ${targetEntity.components.labels.name} on the floor. You see a crumpled ${targetEntity.components.labels.name} on the floor. You see a crumpled ${targetEntity.components.labels.name} on the floor. You see a crumpled ${targetEntity.components.labels.name} on the floor. 
      
      You see a crumpled ${targetEntity.components.labels.name} on the floor. You see a crumpled ${targetEntity.components.labels.name} on the floor. You see a crumpled ${targetEntity.components.labels.name} on the floor. You see a crumpled ${targetEntity.components.labels.name} on the floor.`;
    }
